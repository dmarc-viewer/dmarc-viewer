...
ReportSenderFormSet                 = inlineformset_factory(FilterSet, ReportSender, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Report Sender'})
ReportReceiverDomainFormSet         = inlineformset_factory(FilterSet, ReportReceiverDomain, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Report Receiver Domain'})
SourceIPFormSet                     = inlineformset_factory(FilterSet, SourceIP, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Source IP'})
RawDkimDomainFormSet                = inlineformset_factory(FilterSet, RawDkimDomain, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Raw DKIM Domain'})
RawDkimResultFormSet                = inlineformset_factory(FilterSet, RawDkimResult, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Raw DKIM Result'})
RawSpfDomainFormSet                 = inlineformset_factory(FilterSet, RawSpfDomain, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Raw SPF Domain'})
RawSpfResultFormSet                 = inlineformset_factory(FilterSet, RawSpfResult, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Raw SPF Result'})
AlignedDkimResultFormSet            = inlineformset_factory(FilterSet, AlignedDkimResult, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Aligned DKIM Result'})
AlignedSpfResultFormSet             = inlineformset_factory(FilterSet, AlignedSpfResult, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Aligned SPF Result'})
DispositionFormSet                  = inlineformset_factory(FilterSet, Disposition, can_delete=False, extra=1,
                                    fields=('value',), labels={'value' : 'Dispostion'})
FilterSetFormSet                    = inlineformset_factory(View, FilterSet, can_delete=False, extra=1,
                                    fields=('label', 'color'))