    ...
    ("help-mydmarc", {
        ...
        "items" : OrderedDict([
            ...
            ("mydmarc-deep-analysis", {
                "faq": "The Deep Analysis site",
                "long": """The Deep Analysis section is the heart of the Open DMARC Analyzer. Currently 3 analysis types are supported. A map - showing where messages came from, a time line - showing when messages came, and a table - showing DMARC records from DMARC reports. You can fully control what data, i.e. what reports are displayed by generating analysis views in the View Management section. On top of a view, you see its title and description, a list of the applied filters and the analysis types. Btw. you can also export your views (charts as PDF, table as CSV).""",
                "short": """"""
            }),             
            ("mydmarc-view-management", {
                "faq": "The View Management site",
                "long": """In the View Management you can manage, i.e. create, edit, clone, delete and sort the views for your Deep Analysis section. By dragging the arrow handles (left) you can move views up and down, which will be reflected in the Deep Analysis sidebar. By clicking "Add View", or "Edit" on a particular View you will enter the View Editor, this is where you control what data a view is based on.""",
                "short": """"""
            }),            
            ("mydmarc-view-editor", {
                "faq": "The View Editor",
